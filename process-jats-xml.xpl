...
<p:declare-step
  ...
  <!-- These parameters get passed automatically to any p:xslt. -->
  <p:input port="parameters" kind="parameter"/>

  <!-- Options get used within the pipeline itself. -->
  <p:option name="jats2epub" required="true"/>
  ...
  <p:store href="00-original.xml" name="step-00-original-xml"/>

  <p:identity name="document-source">
    <p:input port="source">
      <p:pipe port="source" step="process-jats-xml"/>
    </p:input>
  </p:identity>
  ...
  <p:load name="format-APA-citations-xslt">
    <!-- hioa-APAcit.xsl imports jats-APAcit.xsl -->
    <p:with-option name="href"
      select="concat($jats2epub,
                     '/assets/hioa-xslt/hioa-citations-prep-APAcit.xsl')"/>
  </p:load>
  <p:xslt name="format-APA-citations" version="2.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="format-APA-citations-xslt" port="result"/>
    </p:input>
  </p:xslt>

  <!-- Stores the APAcit formatted xml-document -->
  <p:store href="10-xml-article-APAcit-preprocessed.xml" name="step-10-xml-article-APAcit-preprocessed"/>
  ...
  <p:load name="fix-element-citation-xslt">
    <p:with-option name="href"
      select="concat($jats2epub,
                     '/assets/hioa-xslt/hioa-mixed-citations-bugfix.xsl')"/>
  </p:load>
  <p:xslt name="fix-element-citation-to-mixed-citation-bug" version="1.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="fix-element-citation-xslt" port="result"/>
    </p:input>
  </p:xslt>

  <p:store name="step-15-xml-book-chapter-bugfixed" href="15-xml-article-APAcit-preprocessed-book-chapter-refs-bugfixed.xml"/>
  ...
  <p:store href="20-xml-article-bugfix-book-chapter-mixed-citation.xml" name="step-20-xml-article-bugfix-book-chapter-mixed-citation"/>
...
<!--    <p:pipe step="format-APA-citations" port="result"/> -->
  ...
  <p:store href="30-xml-article-bugfix-graphic-missing-id.xml" name="step-30-xml-article-bugfix-graphic-missing-id"/>

  <p:load name="display-xhtml-xslt">
    <!-- hioa-xhtml.xsl imports jats-html.xsl -->
    <p:with-option name="href"
      select="concat($jats2epub, '/assets/hioa-xslt/hioa-xhtml.xsl')"/>
  </p:load>
  <p:xslt name="display-xhtml" version="2.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="display-xhtml-xslt" port="result"/>
    </p:input>
  </p:xslt>
  ...
  <p:store omit-xml-declaration="true" indent="true" href="40-xhtml-article-display.html" name="step-40-xhtml-article-display"/>

  <!-- Casts all elements to xhtml namespace. This remedies the problem where some elements get no namespace (xmlns="").-->
  <p:load name="cast-to-xhtml-xslt">
    <!-- hioa-xhtml-namespace-fix.xsl imports the default xhtml-ns.xsl -->
    <p:with-option name="href"
      select="concat($jats2epub,
                     '/assets/hioa-xslt/hioa-xhtml-namespace-fix.xsl')"/>
  </p:load>
  <p:xslt name="cast-to-xhtml" version="1.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="cast-to-xhtml-xslt" port="result"/>
    </p:input>
  </p:xslt>
  ...
  <p:store omit-xml-declaration="true" indent="true" encoding="utf-8" doctype-public="-//W3C//DTD XHTML 1.1//EN" doctype-system="http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd" href="epub/OEBPS/index.html" name="epub-index-html"/>
  ...
  <p:store omit-xml-declaration="true"
    ...
    href="50-xhtml-namespace-fixed-epub-version.html"
  ...
  <p:load name="cast-to-xhtml-and-remove-xmlpi-xslt">
    <!-- this xslt stylesheet removes xml processing instruction and imports assets/jats-xhtml/post/xhtml-ns.xsl -->
    <p:with-option name="href"
      select="concat($jats2epub,
                     '/assets/hioa-xslt/hioa-fix-ns-and-remove-xml-processing-instruction.xsl')"/>
  </p:load>
  <p:xslt name="cast-to-xhtml-and-remove-xml-processing-instruction" version="1.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="cast-to-xhtml-and-remove-xmlpi-xslt" port="result"/>
    </p:input>
  </p:xslt>
  ...
  <p:store omit-xml-declaration="true"
    ...
    doctype-public="-//W3C//DTD HTML 4.01 Transitional//EN"
    doctype-system="http://www.w3.org/TR/html4/loose.dtd"
    href="60-webversion.html"
    name="step-60-webversion"/>

  <!-- EH 2013-12-02: Generate content.opf, a required file in an epub publication -->
  <p:load name="generate-content-opf-xslt">
    <p:with-option name="href"
      select="concat($jats2epub, '/assets/hioa-xslt/epub-content.opf.xsl')"/>
  </p:load>
  <p:xslt name="generate-content-opf" version="1.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="generate-content-opf-xslt" port="result"/>
    </p:input>
  </p:xslt>

  <!-- EH 2014-03-22: storing content.opf in epub structure -->
  <p:store href="epub/OEBPS/content.opf" indent="true" name="content-opf"/>

  <!-- EH 2014-03-22: storing a copy for inspection -->
  <p:store href="70-content.opf" indent="true" name="step-70-content-opf">
    <p:input port="source"><p:pipe step="generate-content-opf" port="result"/></p:input>
  </p:store>

  <p:load name="generate-navmap-xslt">
    <p:with-option name="href"
      select="concat($jats2epub,
                     '/assets/hioa-xslt/generate-navmap-with-toc.xsl')"/>
  </p:load>
  <p:xslt name="generate-navmap-with-toc" version="2.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="generate-navmap-xslt" port="result"/>
    </p:input>
  </p:xslt>

  <!-- EH 2013-12-02: Generate toc.ncx, a required file in an epub publication -->
  <p:load name="generate-toc-xslt">
    <p:with-option name="href"
      select="concat($jats2epub, '/assets/hioa-xslt/epub-toc.ncx.xsl')"/>
  </p:load>
  <p:xslt name="generate-toc-ncx" version="1.0">
    ...
    <p:input port="stylesheet">
      <p:pipe step="generate-toc-xslt" port="result"/>
    </p:input>
  </p:xslt>
  ...
  <!-- EH 2014-03-22: storing content.opf in epub structure -->
  <p:store href="epub/OEBPS/toc.ncx" indent="true" name="toc-ncx"/>

  <!-- EH 2014-03-22: storing a copy for inspection -->
  <p:store href="80-toc.ncx" indent="true" name="step-80-toc-ncx">
