@ehco off
rem for system-wide installation of calabash (able to use the calabash command from any folder),
...
@java -Xmx1024m -jar "C:\Users\username\xproc-pipeline\programs\xmlcalabash\calabash.jar" %*
